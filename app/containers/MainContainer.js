...
class MainContainer extends React.Component {
  ...
  fetchCookingToday() {
    /**
     * Returns a Promise that fetches all CookingToday items from
     * server, then sets cookingToday contents with the retrieved
     * items, and calls error handler on failure.
     * 
     */
    // return new Promise((resolve) => {
    //   getCookingToday()
  ...
  addCookingToday(recipe) {
    /**
     * Given a recipe item, adds it to cookingToday state if the recipe
     * isn't already in cookingToday state. Logs error on failure.
     */
